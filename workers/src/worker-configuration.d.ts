...
declare namespace Cloudflare {
	...
	interface Env {
		...
		STANDARDIZATION_REPO_NAME: "core-github-standardization";
		HEALTH_TEST_REPO_NAME: "testing-oktokit-commands";
		BASE_URL: "https://core-github-api.hacolby.workers.dev";
		MAX_AI_BUDGET: "50";
		USE_OPENAI_MODELS: false;
		GITHUB_REPO_STANDARDIZATION: "jmbish04/core-github-standardization";
		GITHUB_ACTION_WORKER_DISPATCHER_URI: "https://api.github.com/repos/jmbish04/core-github-standardization/dispatches";
		MCP_API_URL: "https://docs.mcp.cloudflare.com/mcp";
		GITHUB_APP_PRIVATE_KEY: string;
		ORCHESTRATOR: DurableObjectNamespace<import("./src/backend/src/index").OrchestratorAgent>;
		RetrofitAgent: DurableObjectNamespace<import("./src/backend/src/index").RetrofitAgent>;
		ROOM_DO: DurableObjectNamespace<import("./src/backend/src/index").RoomDO>;
		GEMINI_AGENT: DurableObjectNamespace<import("./src/backend/src/index").GeminiAgent>;
		PLANNER: DurableObjectNamespace<import("./src/backend/src/index").PlannerAgent>;
		REPO_AGENT: DurableObjectNamespace<import("./src/backend/src/index").RepoAgent>;
		SUPERVISOR: DurableObjectNamespace<import("./src/backend/src/index").Supervisor>;
		DEEP_REASONING_AGENT: DurableObjectNamespace<import("./src/backend/src/index").DeepReasoningAgent>;
		SANDBOX: DurableObjectNamespace<import("./src/backend/src/index").Sandbox>;
		OWNER_AGENT: DurableObjectNamespace<import("./src/backend/src/index").OwnerAgent>;
		RESEARCH_AGENT: DurableObjectNamespace<import("./src/backend/src/index").ResearchAgent>;
		DISCORD_RESEARCH_AGENT: DurableObjectNamespace<import("./src/backend/src/index").DiscordResearchAgent>;
		JULES_OVERSEER: DurableObjectNamespace<import("./src/backend/src/index").JulesOverseer>;
		TOPIC_ORCHESTRATOR: DurableObjectNamespace<import("./src/backend/src/index").TopicOrchestratorAgent>;
		WEB_SEARCH_AGENT: DurableObjectNamespace<import("./src/backend/src/index").WebSearchAgent>;
		JUDGE_AGENT: DurableObjectNamespace<import("./src/backend/src/index").JudgeAgent>;
		REPORTING_AGENT: DurableObjectNamespace<import("./src/backend/src/index").ReportingAgent>;
		LANDING_PAGE_AGENT: DurableObjectNamespace<import("./src/backend/src/index").LandingPageAgent>;
		CLOUDFLARE_DOCS_AGENT: DurableObjectNamespace<import("./src/backend/src/index").CloudflareDocsAgent>;
		DEEP_RESEARCH_CHAT_AGENT: DurableObjectNamespace<import("./src/backend/src/index").DeepResearchChatAgent>;
		HEALTH_DIAGNOSTICIAN: DurableObjectNamespace<import("./src/backend/src/index").HealthDiagnostician>;
		JULES_WEBHOOK_BROADCASTER: DurableObjectNamespace<import("./src/backend/src/index").JulesWebhookBroadcaster>;
		PLANNING_MONITOR: DurableObjectNamespace<import("./src/backend/src/index").PlanningMonitor>;
		REVERSE_ENGINEERING_MONITOR: DurableObjectNamespace<import("./src/backend/src/index").ReverseEngineeringMonitor>;
		PLANNING_SUPERVISOR: DurableObjectNamespace<import("./src/backend/src/index").PlanningSupervisorAgent>;
		PLANNING_ORCHESTRATOR_AGENT: DurableObjectNamespace<import("./src/backend/src/index").PlanningOrchestratorAgent>;
		HONI_ORCHESTRATOR: DurableObjectNamespace<import("./src/backend/src/index").HoniOrchestrator>;
		HONI_CONSULTANT: DurableObjectNamespace<import("./src/backend/src/index").HoniConsultant>;
		WORKSHOP_AGENT: DurableObjectNamespace<import("./src/backend/src/index").WorkshopAgent>;
		AGENT_SESSION_DO: DurableObjectNamespace<import("./src/backend/src/index").AgentSessionDO>;
		CF_WORKSHOP_AGENTS_SDK: DurableObjectNamespace<import("./src/backend/src/index").CfWorkshop_AgentsSdk>;
		STANDARDIZATION_AGENT: DurableObjectNamespace<import("./src/backend/src/index").StandardizationAgent>;
		UX_DESIGN_AGENT: DurableObjectNamespace<import("./src/backend/src/index").UxDesignAgent>;
		...
		STITCH_API_KEY: SecretsStoreSecret;
		...
		SEND_EMAIL_NEWSLETTER: SendEmail;
		"Core Github API": SendEmail;
		VECTORIZE: VectorizeIndex;
		RESEARCH_INDEX: VectorizeIndex;
		VECTORIZE_LOGS: VectorizeIndex;
		PLAN_EMBEDDINGS: VectorizeIndex;
		FILE_EMBEDDINGS: VectorizeIndex;
		BROWSER: Fetcher;
		AI: Ai;
		ASSETS: Fetcher;
		GITHUB_SEARCH_WORKFLOW: Workflow<Parameters<import("./src/backend/src/index").GithubSearchWorkflow['run']>[0]['payload']>;
		DEEP_RESEARCH_WORKFLOW: Workflow<Parameters<import("./src/backend/src/index").DeepResearchWorkflow['run']>[0]['payload']>;
		RESEARCH_ORCHESTRATOR: Workflow<Parameters<import("./src/backend/src/index").ResearchOrchestrator['run']>[0]['payload']>;
		TOPIC_RESEARCH_WORKFLOW: Workflow<Parameters<import("./src/backend/src/index").TopicResearchWorkflow['run']>[0]['payload']>;
		DISCORD_RESEARCH_WORKFLOW: Workflow<Parameters<import("./src/backend/src/index").DiscordResearchWorkflow['run']>[0]['payload']>;
		PLANNING_ORCHESTRATOR: Workflow<Parameters<import("./src/backend/src/index").PlanningOrchestrator['run']>[0]['payload']>;
	}
}
